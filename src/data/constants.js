...
export const Bio = {
  ...
  description:
    "Skilled Software Developer with experience in developing and optimizing Odoo ERP solutions. Proficient in ORM methodologies, PostgreSQL database management, system design, and integrating third-party applications. Demonstrates strong debugging skills,  and a talent for enhancing data processing efficiency. Experienced in designing RESTful APIs with Node.js and Express, and implementing advanced MongoDB queries. Adept at securing applications through JWT and OAuth integrations.A proactive team player with a proven ability to contribute through consistent pull requests.",
  github: "https://github.com/Khushisrivastava202",
  resume:
    "https://drive.google.com/file/d/1b4pUjj3-9y6PFW5Di46VXYmSOke1Yax7/view?usp=sharing",
...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "Axios",
        image: "https://cdn.worldvectorlogo.com/logos/axios.svg",
      },
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "PyCharm",
        image : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7qI4NENnUURoLF3NBiWTVtQ0pJEcw6Sz_9A&s",
      },
    ],
  },
];
...
export const experiences = [
  {
    ...
    date: "Current",
    desc: " 🔯I contribute to the development of open-source solutions globally, using Python, JavaScript, and PostgreSQL.I collaborate with a diverse team of over 150 developers, from apps to infrastructure.Constantly learning, I adapt to new challenges, delivering impactful solutions for Odoo's and their clint's success.",
    skills: [
      "Python",
      "Javascript",
      "PostgreSQL",
  ...
  {
    id: 1,
    img: "https://media.licdn.com/dms/image/v2/C4D0BAQGQjltVvyVwxQ/company-logo_200_200/company-logo_200_200/0/1679913870936/hoping_minds_logo?e=2147483647&v=beta&t=sum4NBQAtYrXQNjXVg67wNvdWQvxM18vGK34aTuHeXU",
    role: "Full Stack Developer ",
    company: "Hoping Minds",
    companyLink: "",
    date: "Jan 2024 - March 2024",
    desc: "Developed a RESTful API using Node.js and Express, enhancing response time and improving system performance by collaborating with front-end developers for seamless API integration. Integrated MongoDB for efficient data handling with optimized CRUD operations and aggregation queries, improving complex dataset retrieval efficiency. Implemented JWT and Google OAuth for secure authentication, enabling successful onboarding of 200+ users in the first month and reducing unauthorized access attempts by 40%",
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
